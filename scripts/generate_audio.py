...
BEATS = [
    ...
    },
    {
        ...
        "text": "اب دیکھیں — ایک دکان اور اس کا دائرہ مکمل طور پر خدمات فراہم کر رہا ہے۔ اب ہم آہستہ آہستہ باہر کی طرف بڑھتے ہیں، اور مشترکہ روٹس پر مزید دکانیں منتخب کرتے ہیں — ہر ایک کے ساتھ اپنا ایک کلومیٹر دائرہ۔ یہ سلسلہ پچاس کلومیٹر تک پھیلایا جائے گا۔"
    },
    {
